    ...
    <router-link to="/ho-so/345">
      <div class="px-3 pt-4">
        ...
        <div class="flex items-start justify-between mt-3">
          <span class="text-sm leading-4 w-1/3 text-VNDG-gray600">NV thu hồi nợ</span>
          <span class="text-sm leading-4 font-bold w-2/3 text-right truncate-3-lines text-VNDG-mainDblue">Nguyễn Văn D</span>
        </div>
        <div class="flex items-start justify-between mt-3">
          <span class="text-sm leading-4 w-1/3 text-VNDG-gray600">Lý do</span>
          <span class="text-sm leading-4 font-bold w-2/3 text-right truncate-3-lines text-VNDG-mainDblue">Nghi ngờ giả mạo thông tin người thân</span>
        </div>
      </div>
      <div class="flex items-center justify-between mt-8 px-3 pb-4">
        <span class="text-sm leading-4 text-VNDG-gray600">Nhân viên AF</span>
      </div>
    </router-link>
    <el-select
      v-model="value"
